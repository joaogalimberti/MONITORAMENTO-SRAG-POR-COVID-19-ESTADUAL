...
3. **Ajustes Estéticos:** O título e os rótulos dos eixos são adicionados para contextualizar o gráfico.
O texto do eixo X (faixas etárias) é inclinado a 45 graus para evitar sobreposição e melhorar a legibilidade.
